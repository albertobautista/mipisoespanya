  ...
  return (
    <section className="py-16 bg-light-gray">
      <div className="max-w-6xl px-4 mx-auto">
        <h2 className="mb-12 text-4xl font-bold text-center text-gray-900 font-poiret">
          ...
          {city.keyFeatures.map((featureKey, index) => (
            <div key={index} className="text-center">
              <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-light-green/30">
                <span className="text-2xl font-bold text-green font-cocomat">
                  {index + 1}
                </span>
              </div>
              <h3 className="mb-2 text-lg font-semibold text-gray-900 font-cocomat">
